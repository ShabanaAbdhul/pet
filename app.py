...
#conn=mysql.connector.pooling.MySQLConnectionPool(host='localhost',user='root',password="shabana@21",db='data',pool_name='DED',pool_size=5, pool_reset_session=True)
mydb=mysql.connector.connect(host="localhost",user="root",password="shabana@21",db='rat1')
